      ...
      <section className="container-page py-12 lg:py-16 space-y-14">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/35 p-8">
          ...
          <div className="relative z-10 max-w-3xl space-y-4">
            ...
            <p className="text-sm text-slate-200 max-w-2xl">
              Aqui não tem “app genérico”. A ideia é simples: reduzir erro,
              retrabalho e tempo perdido com processos manuais. Quando fizer
              sentido, integra com o ecossistema Moduz+. Quando não fizer, fica
              leve e direto.
            </p>
        ...
        <div className="grid gap-6 rounded-2xl border border-slate-800 bg-slate-900/40 p-6 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-200">
              Apps internos, painéis, integrações, formulários e fluxos de
              aprovação.
            </p>
          </div>
          <div>
            ...
            <p className="mt-1 text-sm text-slate-200">
              Descoberta, protótipo funcional, entrega incremental e iteração por
              uso real.
            </p>
          </div>
          <div>
            ...
            <p className="mt-1 text-sm text-slate-200">
              Pode integrar com Moduz+ quando a empresa precisa de escala e
              governança.
            </p>
          </div>
        </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 max-w-4xl">
            <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-4 text-sm text-slate-200">
              ...
              <p className="text-slate-300">
                Se a operação depende de várias folhas/versões, um app organiza e
                reduz erros.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-4 text-sm text-slate-200">
              ...
              <p className="text-slate-300">
                Equipa em campo precisa de registo simples, offline mínimo e
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-4 text-sm text-slate-200">
              ...
              <p className="text-slate-300">
                Checklists, evidências, ordens de serviço e histórico reduzem
                falhas e discussões.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-4 text-sm text-slate-200">
              ...
              <p className="text-slate-300">
                Dashboards e integrações evitam “caça manual” de informação entre
                sistemas.
              </p>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-5 text-sm text-slate-200">
              ...
              <p className="font-semibold text-slate-50">
                Catálogo interno e proposta rápida
              </p>
              <p className="mt-1 text-slate-300">
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-slate-50">
            Alguns apps que já construímos
          </h2>
          <div className="grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl border border-slate-800 bg-slate-900/40 p-5">
              ...
              <p className="mt-1 text-sm text-slate-300">
                App operacional para empresas de obras · ponto, orçamentos e gestão
                de ativos.
              </p>
            </article>
            ...
            <article className="rounded-2xl border border-slate-800 bg-slate-900/40 p-5">
              ...
              <p className="mt-1 text-sm text-slate-300">
                Gestão para escritórios de advocacia · processos, prazos e
                financeiro.
              </p>
            </article>
            ...
            <article className="rounded-2xl border border-slate-800 bg-slate-900/40 p-5">
              ...
              <p className="mt-1 text-sm text-slate-300">
                Gestão de congregações · membros, atividades, finanças e mural
                comunitário.
              </p>
            </article>
          </div>
        ...
        <div className="pt-10 border-t border-slate-800 text-center space-y-4">
          <h2 className="text-2xl font-semibold text-slate-50">
            Quer um app que funcione no dia a dia?
          </h2>
          <p className="max-w-xl mx-auto text-sm text-slate-200">
            Definimos prioridade, escopo e entregamos um piloto funcional sem
            enrolação.
          </p>
          <a
            href="/contato"
