    ...
    <main className="min-h-[calc(100vh-5rem)] bg-slate-950 text-slate-50">
      <section className="container-page py-16 space-y-16">
        ...
        <div className="grid gap-10 lg:grid-cols-[3fr,2fr] lg:items-start">
          ...
          {/* Bloco “Em poucas linhas” com ajuste de alinhamento (meio termo) */}
          <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-6 shadow-xl shadow-black/60 lg:mt-[-3px]">
