      ...
      <section className="container-page py-12 lg:py-16 space-y-12">
        ...
        <div className="max-w-3xl space-y-4">
          ...
          <h1 className="text-3xl font-bold leading-tight md:text-4xl">
            Casos reais — decisões práticas e impacto mensurável
          </h1>
          <p className="text-sm text-slate-200 max-w-2xl">
            Seleção de projetos e intervenções onde aplicámos diagnóstico, desenho
            prático e entregas incrementais. Cada case tem escopo, impacto e lições
            diretas — nada teórico.
          </p>
        </div>
        ...
        <section className="pt-8 border-t border-slate-800 text-center space-y-4">
          <h2 className="text-2xl font-semibold text-slate-50">Tens um case para discutir?</h2>
          <p className="max-w-xl mx-auto text-sm text-slate-200">
            Envia o contexto ou marca uma conversa curta. A partir daí apareço com um plano direto:
            diagnóstico, MVP e métrica de sucesso proposta.
          </p>
          <a
            href="/contato"
