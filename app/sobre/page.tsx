        ...
        <div className="grid gap-10 lg:grid-cols-[2.2fr,1.8fr] lg:items-start">
          ...
          <div className="space-y-6 text-sm text-slate-200">
            <div className="space-y-3">
              ...
              <p>Depois de uma carreira consolidada em contexto corporativo e gestão, em 2022 dei um passo estratégico: uma transição estruturada para tecnologia, já numa fase madura da carreira (40+).</p>
              <p>Em vez de tentar “apagar” o passado profissional, assumi outra linha: usar a experiência em gestão, operações, equipas e clientes como base para atuar em tecnologia com um olhar mais estratégico.</p>
